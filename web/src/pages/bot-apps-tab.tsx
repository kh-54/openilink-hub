      ...
      {installations.length === 0 ? (
        <div className="text-center py-16 space-y-3 border-2 border-dashed rounded-2xl">
          ...
          <Button variant="outline" size="sm" asChild>
            <Link to="/dashboard/apps">浏览应用市场</Link>
          </Button>
        </div>
      ) : (
        ...
        <DialogContent className="sm:max-w-2xl">
          ...
          <div className="py-2">
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              <div className="sm:w-3/5 space-y-5">
                ...
                <div className="space-y-3 pt-2 border-t">
                  <div className="space-y-1.5">
                    <label htmlFor="bot-install-handle" className="text-xs font-medium">
                      Handle
                    </label>
                    <Input
            ...
            <div className="flex justify-end gap-2 pt-4 mt-4 border-t">
              <Button variant="ghost" onClick={() => setConfirmApp(null)}>
                返回
              </Button>
              <Button onClick={doInstall} disabled={installing || !handle.trim()} className="px-6">
                {installing ? <Loader2 className="h-4 w-4 animate-spin mr-1.5" /> : null}
                允许并安装
              </Button>
            </div>
          </div>
